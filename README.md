...
The 3D viewport is managed with HelixToolkit. (There is a [terminal-only fork from OpenCNCPilot called coppercli](https://github.com/thomergil/coppercli) that also works on Linux and Mac.)
